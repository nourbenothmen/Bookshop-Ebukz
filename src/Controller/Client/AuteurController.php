...
{
    #[Route(name: 'client_auteur_index', methods: ['GET'])]
    ...
    #[Route('/new', name: 'client_auteur_new', methods: ['GET', 'POST'])]
    public function new(Request $request, EntityManagerInterface $entityManager): Response
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            return $this->redirectToRoute('client_auteur_index', [], Response::HTTP_SEE_OTHER);
        }
    ...
    #[Route('/{id}', name: 'client_auteur_show', methods: ['GET'])]
    ...
    #[Route('/{id}/edit', name: 'client_auteur_edit', methods: ['GET', 'POST'])]
    ...
    #[Route('/{id}', name: 'client_auteur_delete', methods: ['POST'])]
